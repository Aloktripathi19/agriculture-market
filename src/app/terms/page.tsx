      ...
      <main className="pt-20 min-h-screen bg-slate-50">
        <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 p-8 text-sm leading-relaxed">
            ...
            <p className="text-slate-600 mb-4">Arihant Enterprises operates as an admin-managed crop marketplace. Only the platform administrator can list, update, or remove crop listings. Users may browse and submit inquiries.</p>
            <h2 className="text-xl font-bold text-slate-900 mb-3">Inquiries & Orders</h2>
            <p className="text-slate-600 mb-4">Submitting an inquiry does not constitute a binding order. All orders are confirmed and processed directly between the buyer and Arihant Enterprises through formal agreements.</p>
            ...
            <p className="text-slate-600">For questions about these terms, contact arihant.entt108@gmail.com</p>
          </div>
        </div>
      </main>
      <Footer />
